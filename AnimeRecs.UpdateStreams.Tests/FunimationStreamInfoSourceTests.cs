...
namespace AnimeRecs.UpdateStreams.Tests
{
    ...
    public partial class FunimationStreamInfoSourceTests
    {
        ...
        public void TestRegex()
        {
            ...
            Assert.That(streams, Contains.Item(new AnimeStreamInfo("Haibane Renmei", "http://www.funimation.com/shows/haibane-renmei/videos/episodes/anime", StreamingService.Funimation)));
        }
    }
}
